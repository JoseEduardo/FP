...
public class Lua_UnityEngine_Graphics : LuaObject {
	...
	static public int DrawMesh_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.Mesh),typeof(UnityEngine.Vector3),typeof(UnityEngine.Quaternion),typeof(UnityEngine.Material),typeof(int),typeof(UnityEngine.Camera),typeof(int),typeof(UnityEngine.MaterialPropertyBlock),typeof(bool))){
				UnityEngine.Mesh a1;
